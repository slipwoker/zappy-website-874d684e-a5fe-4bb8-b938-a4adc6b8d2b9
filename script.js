    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Autonomit X Systems משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '874d684e-a5fe-4bb8-b938-a4adc6b8d2b9',
                    name: data.name || '',
                    email: data.email || '',
